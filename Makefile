...
# go tool nm ./depcfg | grep Commit
override LDFLAGS += -X "github.com/bhojpur/deploy/pkg/version.BuildTime=$(shell date -u '+%Y-%m-%d %I:%M:%S %Z')"
override LDFLAGS += -X "github.com/bhojpur/deploy/pkg/version.BuildCommit=$(shell git rev-parse HEAD)"
